...
traintask = dropFeatures(task = traintaskf, features = c("dteday","instant","yr","mnth","cnt"))
testtaskf = makeClassifTask(data = Test  ,target = "countclass")
testtask = dropFeatures(task = testtaskf, features = c("dteday","instant","yr","mnth","cnt"))
traintask$type
```
# Drop features
...
d = as.data.frame(logrpredict$data$response)
d = cbind(d,Test$countclass )
d
```
